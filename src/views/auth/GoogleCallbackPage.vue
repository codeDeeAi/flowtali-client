  ...
  <div class="min-h-screen grid-texture flex flex-col items-center justify-center px-4">
    <div class="auth-card w-full max-w-md p-8 text-center">
      ...
      <div v-if="!error" class="py-8">
        ...
        <p class="text-gray-700">Completing sign-in with Google…</p>
      </div>
      ...
      <div v-else class="py-4">
        ...
        <h2 class="font-sans text-2xl font-semibold text-gray-1000 mb-2">Sign-in failed</h2>
        <p class="text-gray-900 text-sm mb-6">{{ error }}</p>
